...
#include <stdio.h>
#ifndef F_CPU
#define F_CPU Clock Frequency [8000000]:
#endif

#include <avr/sleep.h>
#include "include/simavr/avr/avr_mcu_section.h"
AVR_MCU(F_CPU,"Microcontroller [atmega1284]:");
AVR_MCU_VCD_FILE("build/results/Project name: Lab2_introToAVR_trace.vcd",1000);
